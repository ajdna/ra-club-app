...
```
Agent(
  prompt="Read D:/RA Club/CLUB APP/club-app/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/templates/SECURITY.md`
