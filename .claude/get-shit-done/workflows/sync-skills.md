...
INSTALL_JS_GLOBAL="D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
