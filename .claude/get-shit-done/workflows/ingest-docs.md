...
```bash
INIT=$(node "D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
