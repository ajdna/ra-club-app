...
```
Agent(
  prompt="Read D:/RA Club/CLUB APP/club-app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/templates/VALIDATION.md`
