...
```markdown
Read D:/RA Club/CLUB APP/club-app/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/RA Club/CLUB APP/club-app/.claude/agents/gsd-ui-checker.md for instructions.
