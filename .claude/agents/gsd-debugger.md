...
<required_reading>
@D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/RA Club/CLUB APP/club-app/.claude
                  → checks D:/RA Club/CLUB APP/club-app/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/RA Club/CLUB APP/club-app/.claude/get-shit-done
                  → writes to D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/hooks/
...
@D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/references/common-bug-patterns.md
