...
Use template from `D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/templates/UI-SPEC.md`
