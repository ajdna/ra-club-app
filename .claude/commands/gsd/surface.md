...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/RA Club/CLUB APP/club-app/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=D:/RA Club/CLUB APP/club-app/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=D:/RA Club/CLUB APP/club-app/.claude/commands/gsd
AGENTS_DIR=D:/RA Club/CLUB APP/club-app/.claude/agents
```
...
<execution_context>
Surface state file: `D:/RA Club/CLUB APP/club-app/.claude/skills/.gsd-surface.json`
Install profile marker: `D:/RA Club/CLUB APP/club-app/.claude/skills/.gsd-profile`
Engine module: `D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/RA Club/CLUB APP/club-app/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
